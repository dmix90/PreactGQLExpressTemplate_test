...
function testList() {
    return {
        type: 'TEST',
        payload: [{ id: 1, name: 'The Fellowship of the Ring' }, { id: 2, name: 'The Two Towers' }, { id: 3, name: 'Return of the King' }]
    };
}
function getOneFromList() {
    return {
        type: 'GETONE',
        payload: [{ id: 1, name: 'The Fellowship of the Ring' }]
    };
}
...
var home_Home = function (_Component) {
    ...
    function Home() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.renderList = function (data) {
    ...
    Home.prototype.render = function render(_ref2, state) {
        var data = _ref2.data;

        console.log(data);
        return Object(preact_min["h"])(
            'div',
            { 'class': style_default.a.container },
            home__ref3,
            Object(preact_min["h"])(
                'ul',
                null,
                this.renderList(data.test)
            )
        );
    };
...
var home_mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return bindActionCreators({ testList: testList, getOneFromList: getOneFromList }, dispatch);
};

/* harmony default export */ var home = (connect(mapStateToProps, home_mapDispatchToProps)(home_Home));
// EXTERNAL MODULE: ./style/theme.scss
var theme = __webpack_require__("1xb8");
var theme_default = /*#__PURE__*/__webpack_require__.n(theme);

// CONCATENATED MODULE: ./reducers/test_reducer.js
var test_reducer__extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

/* harmony default export */ var test_reducer = (function () {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var action = arguments[1];
    ...
    switch (action.type) {
        case 'TEST':
            //do something
            return test_reducer__extends({}, state, { test: action.payload });
        case 'GETONE':
            return test_reducer__extends({}, state, { one: action.payload });
        default:
            return state;
    }
});
...
var index_Test = function Test(_ref3) {
...
var createStoreWithMiddleware = applyMiddleware()(createStore_createStore);

var _ref4 = Object(preact_min["h"])(home, { path: '/' });

var _ref5 = Object(preact_min["h"])(Hello, { path: '/test' });

var _ref6 = Object(preact_min["h"])(index_Test, { path: '/testo', test: 'YO' });
...
// removed by extract-text-webpack-plugin
module.exports = {"container":"container__fuYp5"};
